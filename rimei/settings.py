"""
Django settings for rimei project.
...
SECRET_KEY = 'django-insecure-fssad%bs*$y*s7m9v20rg!gf92atur)t8m49r$2slbex7of)=r'
...
WSGI_APPLICATION = 'rimei.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv("DB_PASSWORD", "A12852025a"),
        'HOST': '172.17.0.1',
        'PORT': '5432',
    }
}
...
MEDIA_URL = "/media/"
MEDIA_ROOT = os.path.join(BASE_DIR, "media")  # 确保 `media/` 目录存在
